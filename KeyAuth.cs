...
namespace KeyAuth
{
    public class api
    {
        public string name, ownerid, secret, version, hwid, apiurl, useragent, pcusername, customchecksum;
        /// <summary>
        ...
        public api(string name, string ownerid, string secret, string version, string hwid, string apiurl, string useragent, string pcusername, string customchecksum)
        {
            ...
            this.customchecksum = customchecksum;
        }
        ...
        public void log(string message)
        {
            ...
            var values_to_upload = new NameValueCollection
            {
                ...
                ["pcuser"] = encryption.encrypt(pcusername, enckey, init_iv),
        ...
        {
            MessageBox.Show(message, "KeyAuth Loader Emulation", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        public string req(NameValueCollection post_data)
        {
            try
            {
        ...
        public void load_app_data(app_data_structure data)
        {
        ...
        public void load_user_data(user_data_structure data)
        {
        ...
        public void load_response_struct(response_structure data)
        {
        ...
        public json_wrapper response_decoder = new json_wrapper(new response_structure());
    }
